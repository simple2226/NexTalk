...
export default function NotAllowed({size, color}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill={color} version="1.1" id="Capa_1" width='10px' height={size} viewBox="0 0 55.704 55.703" xmlSpace="preserve">
            <g>
